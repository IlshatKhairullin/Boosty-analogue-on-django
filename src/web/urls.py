...
urlpatterns = [
    ...
    path('post_like/<slug:post_slug>/<int:post_id>', login_required(views.LikePostView), name='post_like'),
    path('comment_like/<slug:post_slug>/<int:post_id>/<int:comment_id>', login_required(views.LikeCommentView),
         name='comment_like'),
    path('home/<slug:tag_slug>/', views.TagIndexView.as_view(), name='posts_by_tag'),
    path('home/<slug:slug>/<int:post_id>/comment/<int:id>/delete', login_required(views.DeleteCommentView.as_view()),
         name='comment_delete'),
    ...
    path('profile/my_posts/<slug:slug>/<int:id>', login_required(views.DetailPostEditView.as_view()),
         name='post_edit_detail'),
    path('profile/my_posts/post-add/', login_required(views.PostCreateView.as_view()), name='post_create'),
    path('profile/my_posts/<str:slug>/<int:id>/delete', login_required(views.PostDeleteView.as_view()),
         name='post_delete'),
