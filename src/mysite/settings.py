...
SIMPLE_JWT = {
    ...
    "SIGNING_KEY": SECRET_KEY,  # секретный ключ для формирования подписи
    "VERIFYING_KEY": "",
    "AUDIENCE": None,
    "ISSUER": None,
    "JSON_ENCODER": None,
    "JWK_URL": None,
    "LEEWAY": 0,
    "AUTH_HEADER_TYPES": ("Bearer",),  # заголовок(ключевое слово) перед токеном в headers in request
    "AUTH_HEADER_NAME": "HTTP_AUTHORIZATION",
    "USER_ID_FIELD": "id",  # идентификатор пользователя
    "USER_ID_CLAIM": "user_id",  # идентификатор пользователя
