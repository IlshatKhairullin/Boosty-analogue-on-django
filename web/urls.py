...
urlpatterns = [
    ...
    path('home/<slug:slug>/<int:post_id>/comment/<int:id>/delete', views.DeleteComment.as_view(), name='comment_delete'),
    path('home/<slug:slug>/<int:post_id>/comment/<int:id>/edit', views.UpdateComment.as_view(), name='comment_edit'),
